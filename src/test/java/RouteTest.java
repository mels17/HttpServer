...
//
//    @Test
//    public void whenGetCoffeeRequestReturn418StatusCode() {
//        Request request = new Request("GET /coffee HTTP/1.1\r\n\r\n");
//        Response actualResponse =  new GeneralGetResponseHandler().process(request);
//        System.out.println(actualResponse.get_header());
//        Assert.assertEquals("418", actualResponse.get_header().split("\r\n")[0].split("\\s")[1]);
//    }
//}
